#!/bin/bash -i
declare LLCK_LOGFILE="/app/ll-tests/gamesvr-blackmesa-freeplay.log";
declare LLCK_CMD="/app/srcds_run -game bms +map gasworks -insecure -maxplayers 8 -norestart +sv_lan 1";
